...
class LocalStorage {
    ...
    static get applicationName() {
        return this.get(local_storage_keys_1.defaultState.APPLICATION.NAME);
    }
    static get version() {
    ...
    static mergePrevious({ currentName, previous, withApplicationName = true, withUserId = false, dontCheckVersion = false, dontUseJsonDecode = false, }) {
        ...
        if (previous === null || previous === void 0 ? void 0 : previous.length) {
            ...
            const prevVersionAppList = (_a = this.prevVersionList) !== null && _a !== void 0 ? _a : [];
    ...
    static checkPrevious(object, dontUseJsonDecode = false) {
        var _a, _b, _c;
        let result = null;
        if ((object === null || object === void 0 ? void 0 : object.CHECKED) === false) {
            // Don`t refactoring, it`s special check
            result = this.mergePrevious({
                currentName: object.CURRENT,
                previous: object.PREVIOUS,
                withApplicationName: (_a = object === null || object === void 0 ? void 0 : object.WITH_APPLICATION_NAME) !== null && _a !== void 0 ? _a : true,
